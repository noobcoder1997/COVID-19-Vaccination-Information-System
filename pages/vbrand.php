...
<div class="row"> 
<div class="col-lg-12"> 
<h1 class="page-header">Vaccines Masterlist</h1> 
...
<strong>COVID Brands Entry</strong> 
</div> 
<!-- /.panel-heading --> 
...
<?php 
include('conn.php'); 
$query=mysqli_query($conn,"select * from `vaccinebrand_table`"); 
while($row=mysqli_fetch_array($query)){ 
?> 
<tr> 
<td><?php echo ucwords($row['dateRecorded']); ?></td> 
...
<?php include('addbrand_modal.php'); ?> 
</div> 
<!-- /.panel-body --> 
</div> 
<!-- /.panel --> 
