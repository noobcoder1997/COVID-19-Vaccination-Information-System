...
<a href="vlocation.php"><i class="fa fa-institution"></i> Sessions</a> 
</li> 
</ul> 
<!-- /.nav-second-level --> 
</li> 
...
<ul class="nav nav-second-level"> 
<li> 
<a href="vUsers.php"><i class="fa fa-list-alt"></i> System Users</a> 
</li> 
</ul> 
<!-- /.nav-second-level --> 
</li> 
...
<div class="row"> 
<div class="col-lg-12"> 
<h1 class="page-header">System Users Masterlist</h1> 
<span class="pull-right"><a href="#addnewuser" data-toggle="modal" class="btn btn-primary"><i class="fa fa-user-plus"></i> Add New</a></span> 
...
//$query=mysqli_query($conn,"select * from `table_user`"); 
...
<td ><?php //echo ucwords($row['Job']); ?></td> 
<td ><?php //echo ucwords($row['Location']); ?></td> 
<td ><?php //echo ucwords($row['Password']); ?></td> 
<td> 
<div class="btn-group"> 
<button type="button" class="btn btn-secondary dropdown-toggle" style="padding-top:0%;padding-bottom:0%;padding-right:0%;padding-left:0%" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Action</button> 
<div class="dropdown-menu dropdown-menu-right" style="background-color:gainsboro;padding-top:0%;padding-bottom:0%;padding-right:0%;padding-left:0%;width:inheret;"> 
